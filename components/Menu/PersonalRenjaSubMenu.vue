<template>
  <div style="padding:0px; margin-bottom:10px;">
    ...
    >
       <el-menu-item 
        :index="index_1"
        :route="{path: `/personal/tim_kerja/${tim_kerja_id}/bawahan` }"
       >
      ...
      <el-menu-item 
        disabled
        :index="index_2"
        :route="{path: `/tim_kerja/${tim_kerja_id}/skp`}"
       >
...
export default {
  ...
  mounted() {
    this.tim_kerja_id = this.$route.params.id;
    this.activeLink = this.$route.fullPath;

    console.log(this.tim_kerja_id)
  },
};
</script>
