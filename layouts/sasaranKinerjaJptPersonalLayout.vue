<template>
  <div class="wrapper" :class="{ 'nav-open': $sidebar.showSidebar }">
    ...
    >
      <sasaran-kinerja-jpt-personal-menu 
...
<script>
  ...
  import SasaranKinerjaJptPersonalMenu from '~/components/Menu/SasaranKinerjaJptPersonalMenu.vue';
